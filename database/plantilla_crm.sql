...
INSERT INTO `addresses` VALUES (1,1,NULL,1,1,1,'CL 18a Sur #10a-35',NULL,NULL,'2026-01-04 01:21:11','2026-01-04 01:21:11'),(2,NULL,2,1,26,884,'CRA 16 # 8-138',NULL,NULL,'2026-01-04 01:21:11','2026-01-04 01:21:11');
...
CREATE TABLE `company_relation_types` (
  ...
  `inverse_name` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `company_relation_types` VALUES (1,'Matriz / Principal','Subsidiaria / Secundaria'),(2,'Subsidiaria / Secundaria','Matriz / Principal'),(3,'Aliada Estratégica','Aliada Estratégica'),(4,'Asociada','Asocida'),(5,'Otro','Otro');
...
CREATE TABLE `emails` (
  ...
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_correo` (`email_address`),
  KEY `user_id` (`user_id`),
  KEY `company_id` (`company_id`),
...
CREATE TABLE `labels` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_nombre` (`first_name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `labels` VALUES (3,'Otra'),(1,'Personal'),(2,'Trabajo');
...
INSERT INTO `user_relation_types` VALUES (1,'Jefe','Empleado','2026-01-04 16:51:26'),(2,'Superior','Asistente','2026-01-04 16:51:26'),(3,'Familiar','Familiar','2026-01-04 16:51:26'),(4,'Mentor','Aprendiz','2026-01-04 16:51:26'),(5,'Amigo','Amigo','2026-01-04 16:51:26'),(6,'Test Padre','Test Hijo','2026-01-04 17:23:17');
...
--
-- Dumping data for table `user_user_relations`
--

LOCK TABLES `user_user_relations` WRITE;
/*!40000 ALTER TABLE `user_user_relations` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_user_relations` ENABLE KEYS */;
UNLOCK TABLES;
